...
pub enum SerializableBigInt {
    #[serde(rename = "Int")]
    Int(String), // decimal string representation of the integer
    #[serde(rename = "BigUInt")]
    BigUInt(String), // decimal string of the (positive) big integer
    #[serde(rename = "BigNInt")]
    BigNInt(String), // decimal magnitude of a negative bignum (actual value = -1 - magnitude)
}
